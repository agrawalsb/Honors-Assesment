...
@app.get("/")
def root():
    return {"message": "Inventory API is running", "endpoints": ["/api/products", "/api/order"]}
...
def create_order(order: OrderRequest):
    ...
    return {"total_price": total_price, "product_name": product['name'], "quantity": order.quantity}
